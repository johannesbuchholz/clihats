...
public class NameTest {
    ...
    public void testName_expectDefaultValuesExceptRequired() {
        ...
        // then
        GlobalTestResult expected = GlobalTestResult.constructSuccess("name-parser", null, null, "my-default", "my-value", null, null, null);
    ...
    public void testName_expectGivenValue() {
        ...
        CliTestInvoker.testGeneratedCliWithThrows(Cli3.class, args);
        // then
        GlobalTestResult expected = GlobalTestResult.constructSuccess("name-parser", "given-value", null, "my-default", "my-value", null, null, null);
        assertEquals(expected, GlobalTestResult.waitForResult());
    }

    @Test
    public void testName_expectGivenValueWithDelimiter() {
        // given
        String[] args = {"name-parser", "-nr", "my-value", "-ndel..##..given-value"};
        // when
        CliTestInvoker.testGeneratedCliWithThrows(Cli3.class, args);
        // then
        GlobalTestResult expected = GlobalTestResult.constructSuccess("name-parser", null, "given-value", "my-default", "my-value", null, null, null);
        assertEquals(expected, GlobalTestResult.waitForResult());
    }
    ...
    public void testName_expectGivenValueInsteadOfCustomDefault() {
        ...
        CliTestInvoker.testGeneratedCliWithThrows(Cli3.class, args);
        // then
        GlobalTestResult expected = GlobalTestResult.constructSuccess("name-parser", null, null, "value-instead-of-default", "my-value", null, null, null);
        assertEquals(expected, GlobalTestResult.waitForResult());
    }
    ...
    public void testName_expectMatchOnAliases() {
        ...
        for (String[] argArray : args) {
            ...
            // then
            GlobalTestResult expected = GlobalTestResult.constructSuccess("name-parser", null, null, "my-default", "my-value", "alias-value", null, null);
            assertEquals(expected, GlobalTestResult.waitForResult());
        }
    }
    ...
    public void testName_expectMappedValue() {
        ...
        CliTestInvoker.testGeneratedCliWithThrows(Cli3.class, args);
        // then
        GlobalTestResult expected = GlobalTestResult.constructSuccess("name-parser", null, null, "my-default", "my-value", null, new MyClass("mapper-value"), null);
        assertEquals(expected, GlobalTestResult.waitForResult());
    }
    ...
    public void testName_expectMappedListValue() {
        ...
        GlobalTestResult expected = GlobalTestResult.constructSuccess(
                "name-parser", null, null, "my-default", "my-value", null, null, List.of(new MyClass("mapper-value-one"), new MyClass("mapper-value-two"))
        );
        assertEquals(expected, GlobalTestResult.waitForResult());
    }
