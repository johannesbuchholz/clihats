...
:prewrap!:
:version: 0.0.1
:tags-example-class-clean: example-class;!annotation-cli;!example-class-main;!annotation-command;!annotation-command-2;!annotation-options-name;!annotation-options-polite
